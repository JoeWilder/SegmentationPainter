...
from PyQt6.QtCore import QThread, pyqtSignal, pyqtBoundSignal, QObject
...
class CheckpointDownloader(QObject):
    ...
    def __init__(self):
        ...
        self._download_urls: Final[list[str]] = ["https://dl.fbaipublicfiles.com/segment_anything/sam_vit_h_4b8939.pth", 
